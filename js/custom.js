            ...
            var $inputs = $('staff_form :input');
                    ...
                    if ($form.data('submitted') === true) {
                      e.preventDefault();
                        ...
                        $.ajax({ type: "POST", url: window.isalon.base_url+'/home/save_staffrequest' , data: send_data }).done(function( msg ) {
            ...
            var $inputs = $('job_form :input');
                ...
                if ($form.data('submitted') === true) {
                      e.preventDefault();
                        ...
                        $.ajax({ type: "POST", url: window.isalon.base_url+'/home/save_jobrequest' , data: send_data }).done(function( msg ) {

...
class Jobs extends CI_Controller {
    ...
    public function job_list()  {
      ...
      $crud->display_as('jobs_client','Stylist Id');
      ...
      $crud->columns('jobs_client','jobs_name','jobs_place_name','jobs_time_from','jobs_time_to','jobs_status');
  ...
  public function _callback_image_url($value,$row){
   ...
   public function jobs_applied()  {
      ...
      $crud = new grocery_CRUD();
      $crud->set_table('isalon_saved_jobs');    
